setwd("/omics/groups/OE0246/internal/guz/cola_hc/examples/LaMannoBrain_human_ips")
library(cola)
...
library(scRNAseq)
data = readRDS('/omics/groups/OE0246/internal/guz/cola_hc/examples/LaMannoBrain_human_ips/LaMannoBrain_human_ips_data.rds')
