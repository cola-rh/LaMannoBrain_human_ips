...
knitr_add_tab_item('collect_classes(res_rh, merge_node = merge_node_param(min_n_signatures = 289))', 'n_signatures \u2265 289', prefix = 'collect-classes-from-hierarchical-partition')
knitr_add_tab_item('collect_classes(res_rh, merge_node = merge_node_param(min_n_signatures = 1372))', 'n_signatures \u2265 1372', prefix = 'collect-classes-from-hierarchical-partition')
knitr_add_tab_item('collect_classes(res_rh, merge_node = merge_node_param(min_n_signatures = 1473))', 'n_signatures \u2265 1473', prefix = 'collect-classes-from-hierarchical-partition')
...
```{r, results = "asis", echo = FALSE, include = TRUE}
knitr_add_tab_item('get_classes(res_rh, merge_node = merge_node_param(min_n_signatures = 289))', 'n_signatures \u2265 289', prefix = 'get-classes-from-hierarchical-partition', hide_and_show = TRUE)
knitr_add_tab_item('get_classes(res_rh, merge_node = merge_node_param(min_n_signatures = 1372))', 'n_signatures \u2265 1372', prefix = 'get-classes-from-hierarchical-partition', hide_and_show = TRUE)
knitr_add_tab_item('get_classes(res_rh, merge_node = merge_node_param(min_n_signatures = 1473))', 'n_signatures \u2265 1473', prefix = 'get-classes-from-hierarchical-partition', hide_and_show = TRUE)
...
dimension_reduction(res_rh, merge_node = merge_node_param(min_n_signatures = 289),
    method = "UMAP", top_value_method = "ATC", top_n = 800, scale_rows = TRUE)', 'n_signatures \u2265 289', prefix = 'dimension-reduction-by-depth', opt = "fig.width = 14, fig.height = 7, out.width = '100%'")
knitr_add_tab_item('par(mfrow = c(1, 2))
dimension_reduction(res_rh, merge_node = merge_node_param(min_n_signatures = 1372),
    method = "UMAP", top_value_method = "SD", top_n = 800, scale_rows = FALSE)
dimension_reduction(res_rh, merge_node = merge_node_param(min_n_signatures = 1372),
    method = "UMAP", top_value_method = "ATC", top_n = 800, scale_rows = TRUE)', 'n_signatures \u2265 1372', prefix = 'dimension-reduction-by-depth', opt = "fig.width = 14, fig.height = 7, out.width = '100%'")
knitr_add_tab_item('par(mfrow = c(1, 2))
dimension_reduction(res_rh, merge_node = merge_node_param(min_n_signatures = 1473),
    method = "UMAP", top_value_method = "SD", top_n = 800, scale_rows = FALSE)
dimension_reduction(res_rh, merge_node = merge_node_param(min_n_signatures = 1473),
    method = "UMAP", top_value_method = "ATC", top_n = 800, scale_rows = TRUE)', 'n_signatures \u2265 1473', prefix = 'dimension-reduction-by-depth', opt = "fig.width = 14, fig.height = 7, out.width = '100%'")
...
```{r, results = 'asis', echo = FALSE, include = TRUE}
knitr_add_tab_item('get_signatures(res_rh, merge_node = merge_node_param(min_n_signatures = 289))', 'n_signatures \u2265 289', opt = 'results="hide"', prefix = 'get-signatures-from-hierarchical-partition')
knitr_add_tab_item('get_signatures(res_rh, merge_node = merge_node_param(min_n_signatures = 1372))', 'n_signatures \u2265 1372', opt = 'results="hide"', prefix = 'get-signatures-from-hierarchical-partition')
knitr_add_tab_item('get_signatures(res_rh, merge_node = merge_node_param(min_n_signatures = 1473))', 'n_signatures \u2265 1473', opt = 'results="hide"', prefix = 'get-signatures-from-hierarchical-partition')
...
```{r, results = 'asis', echo = FALSE, include = TRUE}
knitr_add_tab_item('test_to_known_factors(res_rh, merge_node = merge_node_param(min_n_signatures = 289))', 'n_signatures \u2265 289', prefix = 'test-to-known-factors-from-hierarchical-partition')
knitr_add_tab_item('test_to_known_factors(res_rh, merge_node = merge_node_param(min_n_signatures = 1372))', 'n_signatures \u2265 1372', prefix = 'test-to-known-factors-from-hierarchical-partition')
knitr_add_tab_item('test_to_known_factors(res_rh, merge_node = merge_node_param(min_n_signatures = 1473))', 'n_signatures \u2265 1473', prefix = 'test-to-known-factors-from-hierarchical-partition')
